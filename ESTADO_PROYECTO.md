...
| Intangibles: SIGA vs Excel del coordinador + licencias + alertas | ✅ Cerrado 2026-09-24 — fases 1-3 desplegadas en staging, Excel del coordinador (corte 30/06/2026) cargado y en uso, fusionado a `main` | `openspec/changes/archive/2026-09-24-intangibles-siga-vs-coordinador/` (concilio 5 revisores, APROBADO CON CAMBIOS); specs en `openspec/specs/` (`intangibles-inventory`, `intangibles-coordinator-upload`, `intangibles-reconciliation`, `licenses-from-intangibles`, `expiry-alerts`); guía y runbook en `docs/INTANGIBLES.md`. Alertas solo en la app, sin correo. Decisión abierta: posible doble conteo de licencias manuales vs de intangibles en el KPI del Dashboard. El resto de Vencix se migrará en un cambio posterior |
